function varargout = Gobar_image_filtering(varargin)
% GOBAR_IMAGE_FILTERING MATLAB code for Gobar_image_filtering.fig
%      GOBAR_IMAGE_FILTERING, by itself, creates a new GOBAR_IMAGE_FILTERING or raises the existing
%      singleton*.
%
%      H = GOBAR_IMAGE_FILTERING returns the handle to a new GOBAR_IMAGE_FILTERING or the handle to
%      the existing singleton*.
%
%      GOBAR_IMAGE_FILTERING('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GOBAR_IMAGE_FILTERING.M with the given input arguments.
%
%      GOBAR_IMAGE_FILTERING('Property','Value',...) creates a new GOBAR_IMAGE_FILTERING or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Gobar_image_filtering_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Gobar_image_filtering_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Gobar_image_filtering

% Last Modified by GUIDE v2.5 14-Jan-2021 10:54:29

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Gobar_image_filtering_OpeningFcn, ...
                   'gui_OutputFcn',  @Gobar_image_filtering_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function Gobar_image_filtering_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = Gobar_image_filtering_OutputFcn(hObject, eventdata, handles) 
